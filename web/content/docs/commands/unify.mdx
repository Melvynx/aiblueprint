...
| `projects` | Current working directory | Alias for repository mode. Imports project-local skills, agents, rules, and memories into `.agents`, links `.claude/rules` back to `.agents/rules`, creates `AGENTS.md`, and symlinks `CLAUDE.md` to it. |
